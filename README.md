...
当你希望一篇文章内 2-3 张图都保持“同一个人”时，可使用：

```bash
node toolkit/dist/image-gen.js \
  --provider doubao \
  --consistent-person \
  --reference-image clients/demo/assets/reference-person.png \
  --theme 纯欲 \
  --stock-dir clients/demo/corpus/images/stock \
  --output clients/demo/corpus/images/demo-1.jpg \
