...
// HTTP with retry
// ---------------------------------------------------------------------------
async function httpRetry(method, url, body, retries = 3) {
...
// WeChat stats API
// ---------------------------------------------------------------------------
async function getArticleTotal(token, beginDate, endDate) {
...
async function main() {
    ...
    const history = parseYaml(readFileSync(historyPath, 'utf-8')) ?? [];
